      ...
      <div className="container">
        ...
        <div className="sections">
          <div className="left">
            ...
            <input type="text" placeholder='e.g. I will do something Im good at ' />
            ...
            <textarea name="" id="" cols="30" rows="16"placeholder='Brief description to introduce your service to customerx`'></textarea>
